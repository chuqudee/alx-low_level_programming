`Task 0`:- positive_or_negative.c is a C program that will assign a random number to the variable n each time it is executed, using an if statement.
...
`Advanced Task 100`:- print_comb3.c is a program that prints all possible different combinations of two digits.

`Advanced Task 101`:- print_comb4.c is a program that prints all possible different combinations of three digits.

`Advanced Task 102`:- print_comb5.c is a program that prints all possible combinations of two two-digit numbers.
